var TextureCube = function(gl, mediaFileUrls) {
  var pendingResources = gl.pendingResources;
  pendingResources[mediaFileUrls[0]] =
       ++pendingResources[mediaFileUrls[0]] || 1;
...
TextureCube.prototype.loaded = function(gl){
  ...
  if( --pendingResources[this.mediaFileUrls[0]] === 0 ) {
    delete pendingResources[this.mediaFileUrls[0]];
  }
};